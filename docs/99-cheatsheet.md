...
| ตั้ง branch protection บน private repo ไม่ได้ (403 Upgrade to GitHub Pro) | แผนฟรีรองรับเฉพาะ public repo | อัปเกรดเป็น Team/Pro หรือใช้ `gitleaks`+`pip-audit` ใน CI แทน — ดู [04](04-ci-branch-protection.md) |
